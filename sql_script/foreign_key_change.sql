...
ADD CONSTRAINT starred_wordsID 
    FOREIGN KEY (starred_word_id) REFERENCES user_words (id);
...
ADD CONSTRAINT bookmark_OriginID 
    FOREIGN KEY (origin_id) REFERENCES user_words (id);
...
ADD CONSTRAINT bookmark_translationID 
    FOREIGN KEY (translation_id) REFERENCES user_words (id);
...
ADD CONSTRAINT searchWordID 
    FOREIGN KEY (word_id) REFERENCES user_words (id);